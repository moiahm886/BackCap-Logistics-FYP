...
from './chunk-ODPU3M3Z.mjs';
import {
    g, c, a as a$2, e, j, i, f
}

from './chunk-TRZ6EGBZ.mjs';
export {
    g as PlayMode
}
...
{
    kind: "method",placement:"prototype",key:l,descriptor:t(e.key)
}
...
;return r!=null&&(h.finisher=function(b){r(b,l);}), h
}
...
;function O(r,t) {
    return v({descriptor:e=>{let i={get(){var n,l;return (l=(n=this.renderRoot)===null||n===void 0?void 0:n.querySelector(r))!==null&&l!==void 0?l:null},enumerable:!0,configurable:!0};if(t){let n=typeof e=="symbol"?Symbol():"__"+e;i.get=function(){var l,h;return this[n]===void 0&&(this[n]=(h=(l=this.renderRoot)===null||l===void 0?void 0:l.querySelector(r))!==null&&h!==void 0?h:null),this[n]};}return i}})
}

var L;((L=window.HTMLSlotElement)===null||L===void 0?void 0:L.prototype.assignedElements)!=null?(r,t)= > r.assignedElements(t):(r,t)= > r.assignedNodes(t).filter(e=>e.nodeType===Node.ELEMENT_NODE);var I= {
    name: "@dotlottie/player-component",version:"2.7.12",description:"dotLottie animation player web component.",repository:"https://github.com/dotlottie/player-component.git",homepage:"https://dotlottie.io/players",bugs:"https://github.com/dotlottie/player-component/issues",author:"Jawish Hameed <jawish@lottiefiles.com>",license:"MIT",main:"dist/dotlottie-player.js",module:"dist/dotlottie-player.mjs",types:"dist/dotlottie-player.d.ts",files:["dist"],keywords:["dotlottie","animation","web component","component","lit-element","player"],scripts:

{
    build: "tsup","cypress:open":"cypress open --component",dev:"tsup --watch",lint:"eslint .","lint:fix":"eslint --fix",test:"cypress run --component","type-check":"tsc --noEmit"
}

, dependencies: {
    "@dotlottie/common":"workspace:*",lit:"^2.7.5"
}

, devDependencies: {
    "@vitejs/plugin-legacy":"^4.1.0","axe-core":"^4.7.2",cypress:"^12.11.0","cypress-axe":"^1.4.0","cypress-ct-lit":"^0.3.2","lottie-web":"^5.12.2",terser:"^5.19.0",tsup:"^7.2.0",typescript:"^4.7.4",vite:"^4.3.9"
}
...
;var T="dotlottie-player";var a=class extends b {
    defaultTheme ="";
    container;
    playMode =g.Normal;
    autoplay = !1;
...
{
    lottieWebVersion: j.getLottieWebVersion(),dotLottiePlayerVersion:`$
...
`, n.download=`download_$ {
    this ._seeker
}

.svg`, document.body.appendChild(n), n.click(), document.body.removeChild(n);
}
return i
}
...
renderControls() {
    var i,n,l,h,b;
    let t=((i=this._dotLottieCommonPlayer)==null?void 0:i.currentState)===f.Playing,e=((n=this._dotLottieCommonPlayer)==null?void 0:n.currentState)===f.Paused;
    return a$3` <div id="lottie-controls" aria-label="lottie-animation-controls" class="toolbar"> $

{
    this ._hasMultipleAnimations?a$3` <button @click=$

{
    ()=>this.previous()
}

aria-label="Previous animation" class="btn-spacing-left" >
...
$ {
    t ?a$3` <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M3.99996 2C3.26358 2 2.66663 2.59695 2.66663 3.33333V12.6667C2.66663 13.403 3.26358 14 3.99996 14H5.33329C6.06967 14 6.66663 13.403 6.66663 12.6667V3.33333C6.66663 2.59695 6.06967 2 5.33329 2H3.99996Z" fill="#20272C" /> <path d="M10.6666 2C9.93025 2 9.33329 2.59695 9.33329 3.33333V12.6667C9.33329 13.403 9.93025 14 10.6666 14H12C12.7363 14 13.3333 13.403 13.3333 12.6667V3.33333C13.3333 2.59695 12.7363 2 12 2H10.6666Z" fill="#20272C" /> </svg> `:a$3` <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M3.33337 3.46787C3.33337 2.52312 4.35948 1.93558 5.17426 2.41379L12.8961 6.94592C13.7009 7.41824 13.7009 8.58176 12.8961 9.05408L5.17426 13.5862C4.35948 14.0644 3.33337 13.4769 3.33337 12.5321V3.46787Z" fill="#20272C" /> </svg> `
}
...
aria-label="Next animation" class="btn-spacing-right" >
<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" >
<path
fill-rule="evenodd"
clip-rule="evenodd"
...
class=$ {
    (h=this._dotLottieCommonPlayer) !=null&&h.loop?"active btn-spacing-left":"btn-spacing-left"
}
...
$ {
    this ._hasMultipleAnimations||this._hasMultipleThemes||this._hasMultipleStates?a$3` <button id="lottie-animation-options" @click=$
...
$ {
    this ._popoverIsOpen?a$3` <div id="popover" class="popover" tabindex="0" aria-label="lottie animations themes popover" style="min-height: ${this.themes().length>0?"84px":"auto"}" > $

{
    !this._animationsTabIsOpen&&!this._styleTabIsOpen&&!this._statesTabIsOpen?a$3` <button class="popover-button" tabindex="0" aria-label="animations" @click=$
...
$ {
    this ._hasMultipleThemes&& !this._styleTabIsOpen&&!this._animationsTabIsOpen&&!this._statesTabIsOpen?a$3` <button class="popover-button" aria-label="Themes" @click=$
...
$ {
    this ._hasMultipleStates&& !this._styleTabIsOpen&&!this._animationsTabIsOpen&&!this._statesTabIsOpen?a$3` <button class="popover-button" aria-label="States" @click=$
...
$ {
    this ._animationsTabIsOpen?a$3`<button class="option-title-button" aria-label="Back to main popover menu" @click=$
...
<ul >
$ {
    this .animations().map(s=>a$3` <li> <button class="option-button" aria-label=${`${s}`} @click=${()=>{this._animationsTabIsOpen=!this._animationsTabIsOpen,this._popoverIsOpen=!this._popoverIsOpen,this.play(s),this.requestUpdate();}} @keydown=${c=>{(c.code==="Space"||c.code==="Enter")&&(this._animationsTabIsOpen=!this._animationsTabIsOpen,this._popoverIsOpen=!this._popoverIsOpen,this.play(s),this.requestUpdate());}} > <div class="option-tick"> ${this.currentAnimation()===s?a$3`
                                        <svg
                                          width="24"
                                          height="24"
                                          viewBox="0 0 24 24"
                                      ...
                                      `:a$3`<div style="width: 24px; height: 24px"></div>`} </div> <div>${s}</div> </button> </li> `)
}
...
$ {
    this ._styleTabIsOpen?a$3`<div class="option-title-themes-row"> <button class="option-title-button themes" aria-label="Back to main popover menu" @click=$
...
$ {
    ((b=this._dotLottieCommonPlayer)==null?void 0:b.defaultTheme)===""?a$3``:a$3` <button class="reset-btn" @click=$
...
<ul >
$ {
    this ._themesForCurrentAnimation.map(s=>a$3` <li> <button class="option-button" aria-label="${s.id}" @click=${()=>{this.setTheme(s.id);}} @keydown=${c=>{(c.code==="Space"||c.code==="Enter")&&this.setTheme(s.id);}} > <div class="option-tick"> ${this.getDefaultTheme()===s.id?a$3`
                                        <svg
                                          width="24"
                                          height="24"
                                          viewBox="0 0 24 24"
                                      ...
                                      `:a$3`<div style="width: 24px; height: 24px"></div>`} </div> <div>${s.id}</div> </button> </li> `)
}
...
$ {
    this ._statesTabIsOpen?a$3`<div class="option-title-themes-row"> <button class="option-title-button themes" aria-label="Back to main popover menu" @click=$
...
<ul >
$ {
    this ._statesForCurrentAnimation.map(s=>a$3` <li> <button class="option-button" aria-label="${s}" @click=${()=>{this.enterInteractiveMode(s);}} @keydown=${c=>{(c.code==="Space"||c.code==="Enter")&&this.enterInteractiveMode(s);}} > <div class="option-tick"> ${this.getActiveStateMachine()===s?a$3`
                                        <svg
                                          width="24"
                                          height="24"
                                          viewBox="0 0 24 24"
...
render() {
    ...
    return a$3` <div id="animation-container" class=$

{
    t
}

lang="en" role="img" aria-label="lottie-animation-container" >
